...
MessageWriter = IteratorJoin(
  MessageWriterIterator(message),
  CanvasWriterIterator(canvas)
): null

MessageWriter = IteratorJoin(
  CanvasReaderIterator(canvas),
  MessageReaderIterator()
): message
...
MessageWriterIterator(message).execute()
...
[start]
       [**********************]
                                          [endend]
                               [endend]
[chunkkkkkk]                   [chunkkkkkk][chunkkkkkk]